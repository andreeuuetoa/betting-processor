...
public class Main {
    public static void main(String[] args) {
	    Path matchDataPath = Paths.get("src", "bettingprocessor/main", "resources", "match_data.txt");
		Path playerDataPath = Paths.get("src", "bettingprocessor/main", "resources", "player_data.txt");
		Path resultPath = Paths.get("src", "bettingprocessor/main", "java", "bettingprocessor/main", "results.txt");
